  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>{isStreaming ? "Tænker…" : "Tanker"}</span>
        <ChevronDownIcon
      ...
      <CollapsibleContent>
        <div className="mt-2 rounded-md border border-border/50 bg-muted/30 p-3 text-xs whitespace-pre-wrap text-muted-foreground">
          {children}
        </div>
      </CollapsibleContent>
    </Collapsible>
